...
prediction_label = tk.Label(result_frame, text="Prediction: ", bg="#f0f0f0")
prediction_label.pack(side="left", padx=5)

label_label = tk.Label(result_frame, text="Label: ", bg="#f0f0f0")
label_label.pack(side="left", padx=5)

# Footer Label
footer_label = tk.Label(root, text="©2023 Digit Recognition. All rights reserved.", font=("Helvetica", 8), bg="#f0f0f0")
